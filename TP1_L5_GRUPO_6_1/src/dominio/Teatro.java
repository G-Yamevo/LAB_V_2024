...
public class Teatro extends Entrada implements IGenero{
	...
	//Constructor
	public Teatro(int numeroUnico, String nombreShow, String dia, String hora, String tiempoDuracion, 
			float costo, String genero, String actorPrincipal1, String actorPrincipal2,String actorPrincipal3) {
